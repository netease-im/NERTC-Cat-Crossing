...
#ifndef NERTC_ENGINE_EVENT_HANDLER_H_
#define NERTC_ENGINE_EVENT_HANDLER_H_
...
class IRtcEngineEventHandler {
   public:
    ...
    /** 发生错误回调。
     ...
     @param error_code 错误码。详细信息请参考 #NERtcErrorCode
     @param msg 错误描述。
     */
    ...
    /** 发生调用异常回调。
     ...
     该回调方法表示 SDK 运行时出现了异步调用。

     @param error_code 错误代码: #NERtcErrorCode.
     @param msg 警告描述。
     */
    virtual void onAsyncCall(int error_code, const char* msg) {
        (void)error_code;
        (void)msg;
    }
