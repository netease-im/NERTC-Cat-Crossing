...
/**
 ...
 - \ref nertc::IRtcEngineEx::getConnectionState "getConnectionState"
 - \ref nertc::IRtcEngine::queryInterface "queryInterface"
 ...
 - \ref nertc::IRtcEngineEventHandler::onReconnectingStart "onReconnectingStart"
 - \ref nertc::IRtcEngineEventHandler::onConnectionStateChange "onConnectionStateChange"
 - \ref nertc::IRtcEngineEventHandler::onReleasedHwResources "onReleasedHwResources"
 ...
 - \ref nertc::IAudioDeviceManager::adjustRecordingSignalVolume "adjustRecordingSignalVolume"
 - \ref nertc::IAudioDeviceManager::adjustPlaybackSignalVolume "adjustPlaybackSignalVolume"
 ...
 - \ref nertc::IRtcEngineEx::setLocalVideoMirrorMode "setLocalVideoMirrorMode"

 ### 屏幕共享
 本组方法适用于云信如下产品： 视频通话。
 - \ref nertc::IRtcEngineEx::startScreenCaptureByScreenRect "startScreenCaptureByScreenRect"
 - \ref nertc::IRtcEngineEx::startScreenCaptureByDisplayId "startScreenCaptureByDisplayId"
 - \ref nertc::IRtcEngineEx::startScreenCaptureByWindowId "startScreenCaptureByWindowId"
 - \ref nertc::IRtcEngineEx::updateScreenCaptureRegion "updateScreenCaptureRegion"
 - \ref nertc::IRtcEngineEx::stopScreenCapture "stopScreenCapture"
 - \ref nertc::IRtcEngineEx::pauseScreenCapture "pauseScreenCapture"
 - \ref nertc::IRtcEngineEx::resumeScreenCapture "resumeScreenCapture"
 ...
 - \ref nertc::IRtcEngineEx::setLocalSubStreamRenderMode "setLocalSubStreamRenderMode"
 - \ref nertc::IRtcEngineEx::setRemoteSubSteamRenderMode "setRemoteSubSteamRenderMode"
 ...
 - \ref nertc::IRtcEngineEventHandlerEx::onFirstAudioFrameDecoded "onFirstAudioFrameDecoded"
 - \ref nertc::IRtcEngineEventHandlerEx::onFirstVideoFrameDecoded "onFirstVideoFrameDecoded"

 ### 数据统计事件
    本组方法适用于云信如下产品： 语音通话、视频通话。
 - \ref nertc::IRtcEngineEx::setStatsObserver "setStatsObserver"
 - \ref nertc::IRtcMediaStatsObserver::onRtcStats "onRtcStats"
 - \ref nertc::IRtcMediaStatsObserver::onLocalAudioStats "onLocalAudioStats"
 - \ref nertc::IRtcMediaStatsObserver::onRemoteAudioStats "onRemoteAudioStats"
 - \ref nertc::IRtcMediaStatsObserver::onLocalVideoStats "onLocalVideoStats"
 - \ref nertc::IRtcMediaStatsObserver::onRemoteVideoStats "onRemoteVideoStats"
 - \ref nertc::IRtcMediaStatsObserver::onNetworkQuality "onNetworkQuality"

 ### 伴音管理
    本组方法适用于云信如下产品： 语音通话。
 - \ref nertc::IRtcEngineEx::startAudioMixing "startAudioMixing"
 - \ref nertc::IRtcEngineEx::stopAudioMixing "stopAudioMixing"
 - \ref nertc::IRtcEngineEx::pauseAudioMixing "pauseAudioMixing"
 - \ref nertc::IRtcEngineEx::resumeAudioMixing "resumeAudioMixing"
 - \ref nertc::IRtcEngineEx::setAudioMixingPlaybackVolume "setAudioMixingPlaybackVolume"
 - \ref nertc::IRtcEngineEx::setAudioMixingSendVolume "setAudioMixingSendVolume"
 - \ref nertc::IRtcEngineEx::getAudioMixingPlaybackVolume "getAudioMixingPlaybackVolume"
 - \ref nertc::IRtcEngineEx::getAudioMixingSendVolume "getAudioMixingSendVolume"
 - \ref nertc::IRtcEngineEx::getAudioMixingDuration "getAudioMixingDuration"
 - \ref nertc::IRtcEngineEx::getAudioMixingCurrentPosition "getAudioMixingCurrentPosition"
 - \ref nertc::IRtcEngineEx::setAudioMixingPosition "setAudioMixingPosition"
 - \ref nertc::IRtcEngineEventHandlerEx::onAudioMixingStateChanged "onAudioMixingStateChanged"
 - \ref nertc::IRtcEngineEventHandlerEx::onAudioMixingTimestampUpdate "onAudioMixingTimestampUpdate"

 ### 音效管理
    本组方法适用于云信如下产品： 语音通话。

 - \ref nertc::IRtcEngineEx::getEffectPlaybackVolume "getEffectPlaybackVolume"
 - \ref nertc::IRtcEngineEx::setEffectPlaybackVolume "setEffectPlaybackVolume"
 - \ref nertc::IRtcEngineEx::playEffect "playEffect"
 - \ref nertc::IRtcEngineEx::stopEffect "stopEffect"
 - \ref nertc::IRtcEngineEx::stopAllEffects "stopAllEffects"
 - \ref nertc::IRtcEngineEx::pauseEffect "pauseEffect"
 - \ref nertc::IRtcEngineEx::pauseAllEffects "pauseAllEffects"
 - \ref nertc::IRtcEngineEx::resumeEffect "resumeEffect"
 - \ref nertc::IRtcEngineEx::resumeAllEffects "resumeAllEffects"
 - \ref nertc::IRtcEngineEx::setEffectSendVolume "setEffectSendVolume"
 - \ref nertc::IRtcEngineEx::getEffectSendVolume "getEffectSendVolume"
 - \ref nertc::IRtcEngineEventHandlerEx::onAudioEffectFinished "onAudioEffectFinished"

 ### 定制方法
    本组方法适用于云信如下产品： 互动直播。
 - \ref nertc::IRtcEngineEx::addLiveStreamTask "addLiveStreamTask"
 - \ref nertc::IRtcEngineEx::updateLiveStreamTask "updateLiveStreamTask"
 - \ref nertc::IRtcEngineEx::removeLiveStreamTask "removeLiveStreamTask"
 - \ref nertc::IRtcEngineEventHandlerEx::onAddLiveStreamTask "onAddLiveStreamTask"
 - \ref nertc::IRtcEngineEventHandlerEx::onUpdateLiveStreamTask "onUpdateLiveStreamTask"
 - \ref nertc::IRtcEngineEventHandlerEx::onRemoveLiveStreamTask "onRemoveLiveStreamTask"
 - \ref nertc::IRtcEngineEventHandlerEx::onLiveStreamState "onLiveStreamState"

 ### 音量提示
    本组方法适用于云信如下产品： 语音通话。
 - \ref nertc::IRtcEngineEx::enableAudioVolumeIndication "enableAudioVolumeIndication"
 - \ref nertc::IRtcEngineEventHandlerEx::onRemoteAudioVolumeIndication "onRemoteAudioVolumeIndication"
 - \ref nertc::IRtcEngineEventHandlerEx::onLocalAudioVolumeIndication "onLocalAudioVolumeIndication"

 ### 耳返
    本组方法适用于云信如下产品： 语音通话。
 - \ref nertc::IRtcEngineEx::enableEarback "enableEarback"
 - \ref nertc::IRtcEngineEx::setEarbackVolume "setEarbackVolume"

 ### 视频大小流
    本组方法适用于云信如下产品： 视频通话。
 - \ref nertc::IRtcEngineEx::enableDualStreamMode "enableDualStreamMode"


 ### 自定义音频
    本组方法适用于云信如下产品： 语音通话。
 - \ref nertc::IRtcEngineEx::setExternalAudioSource "setExternalAudioSource"
 - \ref nertc::IRtcEngineEx::pushExternalAudioFrame "pushExternalAudioFrame"

 ### 自定义视频采集
    本组方法适用于云信如下产品： 视频通话。
 - \ref nertc::IRtcEngineEx::setExternalVideoSource "setExternalVideoSource"
 - \ref nertc::IRtcEngineEx::pushExternalVideoFrame "pushExternalVideoFrame"
 ...
 ### 音频设备IAudioDeviceManager
    本组方法适用于云信如下产品： 语音通话。
 - \ref nertc::IAudioDeviceManager::enumerateRecordDevices "enumerateRecordDevices"
 - \ref nertc::IAudioDeviceManager::setRecordDevice "setRecordDevice"
 - \ref nertc::IAudioDeviceManager::getRecordDevice "getRecordDevice"
 - \ref nertc::IAudioDeviceManager::enumeratePlayoutDevices "enumeratePlayoutDevices"
 - \ref nertc::IAudioDeviceManager::setPlayoutDevice "setPlayoutDevice"
 - \ref nertc::IAudioDeviceManager::getPlayoutDevice "getPlayoutDevice"
 - \ref nertc::IAudioDeviceManager::setRecordDeviceVolume "setRecordDeviceVolume"
 - \ref nertc::IAudioDeviceManager::getRecordDeviceVolume "getRecordDeviceVolume"
 - \ref nertc::IAudioDeviceManager::setPlayoutDeviceVolume "setPlayoutDeviceVolume"
 - \ref nertc::IAudioDeviceManager::getPlayoutDeviceVolume "getPlayoutDeviceVolume"
 - \ref nertc::IAudioDeviceManager::setPlayoutDeviceMute "setPlayoutDeviceMute"
 - \ref nertc::IAudioDeviceManager::getPlayoutDeviceMute "getPlayoutDeviceMute"
 - \ref nertc::IAudioDeviceManager::setRecordDeviceMute "setRecordDeviceMute"
 - \ref nertc::IAudioDeviceManager::getRecordDeviceMute "getRecordDeviceMute"
 - \ref nertc::IAudioDeviceManager::startRecordDeviceTest "startRecordDeviceTest"
 - \ref nertc::IAudioDeviceManager::stopRecordDeviceTest "stopRecordDeviceTest"
 - \ref nertc::IAudioDeviceManager::startPlayoutDeviceTest "startPlayoutDeviceTest"
 - \ref nertc::IAudioDeviceManager::stopPlayoutDeviceTest "stopPlayoutDeviceTest"
 - \ref nertc::IAudioDeviceManager::startAudioDeviceLoopbackTest "startAudioDeviceLoopbackTest"
 - \ref nertc::IAudioDeviceManager::stopAudioDeviceLoopbackTest "stopAudioDeviceLoopbackTest"
 - \ref nertc::IRtcEngineEventHandlerEx::onAudioHowling "onAudioHowling"

 ### 视频设备IVideoDeviceManager
    本组方法适用于云信如下产品： 视频通话。
 - \ref nertc::IVideoDeviceManager::enumerateCaptureDevices "enumerateCaptureDevices"
 - \ref nertc::IVideoDeviceManager::setDevice "setDevice"
 - \ref nertc::IVideoDeviceManager::getDevice "getDevice"

 ### 设备管理事件
    本组方法适用于云信如下产品： 语音通话。
 - \ref nertc::IRtcEngineEventHandlerEx::onAudioDeviceStateChanged "onAudioDeviceStateChanged"
 - \ref nertc::IRtcEngineEventHandlerEx::onAudioDefaultDeviceChanged "onAudioDefaultDeviceChanged"
 - \ref nertc::IRtcEngineEventHandlerEx::onVideoDeviceStateChanged "onVideoDeviceStateChanged"

 ### 故障排查
    本组方法适用于云信如下产品： 语音通话、视频通话。
 - \ref nertc::IRtcEngineEx::startAudioDump "startAudioDump"
 - \ref nertc::IRtcEngineEx::stopAudioDump "stopAudioDump"
 - \ref nertc::IRtcEngineEx::uploadSdkInfo "uploadSdkInfo"
...
/**
 ...
 @defgroup DefKeys Keys for Interface
 @defgroup ParameterKeys Keys for setParameters
 */

#ifndef NERTC_ENGINE_H_
#define NERTC_ENGINE_H_
...
struct NERtcEngineContext {
    ...
    void* egl_context; /**< android 外部用户创建 EGL上下文, android.opengl.EGLContext 或者
...
class IRtcEngine {
   public:
    ...
    /** 初始化 NERTC SDK 服务。
     ...
     在调用 createNERtcEngine() 方法创建 IRtcEngine
    ...
    /** 销毁 NERtc 实例，释放资源。
     ...
     该方法释放 NERTC SDK 使用的所有资源。有些 App
     只在用户需要时才进行实时音视频通信，不需要时则将资源释放出来用于其他操作，该方法适用于此类情况。

     调用 release 方法后，您将无法再使用 SDK 的其它方法和回调。如需再次使用实时音视频通话功能，您必须重新创建一个新的 NERtc
     实例。
    ...
    */
    ...
    /** 设置本地视图。
     ...
     App 通过调用此接口绑定本地视频流的显示视窗(view)。 在 App
