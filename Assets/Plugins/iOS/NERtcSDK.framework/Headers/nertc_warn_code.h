...
#ifndef NERTC_WARN_CODE_H_
#define NERTC_WARN_CODE_H_
...
typedef enum
{
    ...
    kNERtcWarnInitVideo =
        101, /**< 初始化视频功能失败。有可能是因视频资源被占用导致的。用户无法看到视频画面，但不影响语音通信。*/
    kNERtcWarnPending = 102, /**< 请求处于待定状态。一般是由于某个模块还没准备好，请求被延迟处理。*/
    kNERtcWarnNoFrame = 103, /**< 摄像头无数据帧。请检查摄像头或者切换摄像头。*/
    // ADM 模块
    ...
    kNERtcWarnADMWinCoreNoDataReadyEvent =
        2000, /**< 音频设备模块：音频驱动异常。解决方案：禁用并重新使能音频设备，或者重启机器，或者更新声卡驱动。*/
    ...
    kNERtcWarnADMWinCoreImproperCaptureRelease =
        2003, /**< 音频设备模块：音频采集释放有误。解决方案：禁用并重新使能音频设备，或者重启机器，或者更新声卡驱动。*/
